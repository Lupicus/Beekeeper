...
public class ModPOI
{
	public static final ResourceKey<PoiType> BEEKEEPER_KEY = ResourceKey.create(Registry.POINT_OF_INTEREST_TYPE_REGISTRY, new ResourceLocation(Main.MODID, "beekeeper"));
